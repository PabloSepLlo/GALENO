<?php
    ...
    class Consultas_ingreso {
        ...
        public function get_datos_ingresos() {
            $stmt = $this->pdo->prepare("
                SELECT 
        ...
        public function get_ingreso_pr() {
            $stmt = $this->pdo->prepare("
                SELECT 
        ...
        public function get_ingreso_mi() {
            $stmt = $this->pdo->prepare("
                SELECT 
        ...
        public function get_ingreso_destino() {
            $stmt = $this->pdo->prepare("
                SELECT 
        ...
        public function get_porcentaje_muerte_domicilio() {
            $stmt = $this->pdo->prepare("
                SELECT 
        ...
        public function get_media_dias_ingreso() {
            $stmt = $this->pdo->prepare("
                SELECT 
