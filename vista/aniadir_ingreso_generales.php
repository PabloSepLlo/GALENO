                    ...
                    <div class='card p-4 shadow-lg w-50'>
                        ...
                        echo "<form method='POST'>
                            <div class='row d-flex justify-content-end'>
                                <button type='submit' class='btn btn-danger col-sm-2 col-md-1 d-flex justify-content-center align-items-center' formaction='../controlador/borrar_datos_formulario.php' title='Borrar datos y salir'>
                            ...
                            <div class='row d-flex justify-content-end'>
                                    <button type='submit' formaction='../controlador/guardar_generales_ingreso.php' class='btn btn-primary col-sm-2 col-md-1 d-flex justify-content-center align-items-center' title='Guardar y continuar'>
