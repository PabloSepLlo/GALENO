<?php
    ...
    session_start();
    if (isset($_POST["fecha_inicio"], $_POST["fecha_fin"]) && !empty($_POST["fecha_inicio"]) && !empty($_POST["fecha_fin"]) && $_POST["fecha_fin"] > $_POST["fecha_inicio"]) {
        ...
        $_SESSION["err"] = "Las fechas no están definidas o son incorrectas";
