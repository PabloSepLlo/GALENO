...
<body>
    <?php 
        ...
        if (isset($_GET["filtrarCS"])) {
            echo "<div class='modal fade show' id='modalFiltroCS' tabindex='-1' style='display: block; background: rgba(0,0,0,0.5);' aria-labelledby='modalFiltroCSLabel'>
