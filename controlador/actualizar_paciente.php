<?php
    ...
    if(isset($_SESSION["nhc"], $_SESSION["nombre"], $_SESSION["ape1"], $_SESSION["sexo"], $_SESSION["edad"])){
        ...
        $paciente->cargar_datos($_SESSION["id_ingreso"], $_SESSION["nhc"], $_SESSION["nombre"], $_SESSION["ape1"], $_SESSION["ape2"], $_SESSION["sexo"], $_SESSION["edad"], 
        ...
        if ($paciente->actualizar_paciente()){
            ...
            $_SESSION["err"] = "No se ha podido actualizar el paciente, revise los datos";
            header("Location: ../vista/vista_resumen_paciente.php");
            exit();
        }
    }
    else {
        $_SESSION["err"] = "Ha habido algún problema con los parametros";
        header("Location: ../vista/vista_resumen_paciente.php");
        exit();
    }
?>